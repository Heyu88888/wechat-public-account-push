...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxd776131cbd71f084',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '518b41b8ccb23717f2f83902f0984fd2',
   ...
   */
  USERS: [orWbm6DcONEEajlB_iGV9rzR4oKA
    {
      // 想要发送的人的名字
      name: '老婆0',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'b1JU-OsbuP97Tla6s4ec35f602LlzCQIfqcQvvrsAO4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'b1JU-OsbuP97Tla6s4ec35f602LlzCQIfqcQvvrsAO4',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
